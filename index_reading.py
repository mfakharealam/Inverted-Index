...
def get_term_details(term):
    ...
    if term is not None:
        ...
        with open("termids.txt", "r", encoding="utf-8") as terms_id_file, open("term_index.txt", "r", encoding="utf-8") as term_index_file:
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == '--term':
        ...
        print("*** Index Reading Format is: '--term [The_term]' ***")
